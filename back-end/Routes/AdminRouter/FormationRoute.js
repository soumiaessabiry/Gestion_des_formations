...
const {Ajouterformation,UpdateFormation,DeletFormation,AfficheFormations,CountFormation}=require("../../Controllers/FormationController")
...
router.get('/CountFormation',[verifyToken,AdminMiddleware],CatchError(CountFormation))
